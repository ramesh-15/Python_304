...
d_origin={"Front":1,"Left":2,"Back":3,"Right":4,"Up":5,"Down":6}
dict_horizontal_right={"Front":1,"Left":2,"Back":3,"Right":4}
...
while True:
    ...
    if dice=="right":
        ...
        if c==0:
            ...
            lst_1.pop()
            print(lst_1)
        #progress vert. to horiz.
        if d_origin!=dict_horizontal_right:
