...
#output:
enter current status of light:green
The changed light is : yellow
enter current status of light:yellow
The changed light is : red
enter current status of light:red
